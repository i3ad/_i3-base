<?php
	...
	if ( post_password_required() ) { ?>
		<?php _e('This post is password protected. Enter the password to view comments.','_i3-base'); ?>
	<?php
		return;
	}
?>
...
<?php if ( have_comments() ) : ?>
	...
	<h2 id="comments"><?php comments_number(__('No Responses', '_i3-base'), __('One Response', '_i3-base'), __('% Responses', '_i3-base') );?></h2>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ( comments_open() ) : ?>
	 ...
	 <?php else : // comments are closed ?>
		<p><?php _e('Comments are closed.','_i3-base'); ?></p>
